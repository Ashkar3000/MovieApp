                        ...
                        <div className="card rounded-3 text-black">
                            <div className="row g-0">
                                <div className="col-lg-12">
                                            {/* <button className="btn" oncli><Close /></button> */}
                                    <div className="card-body p-md-5 mx-md-4">
                                        ...
                                        <form>
                                            <h4 className="text-center fw-bold">Please login to your account</h4>
                                            ...
                                            <div className="d-flex align-items-center justify-content-center">
                                                ...
                                                <button type="button" className="button2" onClick={register}>Create new</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
